...
//纯文本
#import "XWPublishOnlyTextController.h"
//链接
#import "XWPublishLinkController.h"
...
- (void)touchDownBtn:(PublishMenuButton *)btn{
    ...
    if (btn.tag == 1000) {
        //纯文本
        XWPublishOnlyTextController *publishTextVC = [[XWPublishOnlyTextController alloc] init];
        ...
        //链接 
        XWPublishLinkController *publishLinkVC = [[XWPublishLinkController alloc] init];
